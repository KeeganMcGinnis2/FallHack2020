...
function App() {
  return (
    <div className="App">
      ...
      <Toilet address="4175 Wallace Street" type="Restroom" smell="5.0" clean="5.0" avgrating="5.0" totalratings="3" distance="0.9" lat="49.2494269600837" lon="-123.19112496205"/>
      </div> */}
      <MyComponent/>
    </div>
  );
