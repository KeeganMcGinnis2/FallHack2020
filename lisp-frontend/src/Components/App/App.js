  ...
  return (
    <div className="App">
      ...
      <div style={{marginTop:"12vh"}}>
        ...
        <Toilet address="4175 Wallace Street" type="Restroom" smell="5.0" clean="5.0" avgrating="5.0" totalratings="3" distance="1.2" lat="49.2494269600837" lon="-123.19112496205"/>
        <Toilet address="4175 Wallace Street" type="Restroom" smell="4.0" clean="4.0" avgrating="4.0" totalratings="1" distance="1.3" lat="49.2494269600837" lon="-123.19112496205"/>
      </div>
      <MyComponent/>
    </div>
  );
